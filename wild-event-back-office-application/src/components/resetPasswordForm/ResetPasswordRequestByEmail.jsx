...
import { Button, TextField, Typography, Box, Snackbar, DialogContentText } from '@mui/material';
...
const ResetPasswordRequestByEmail = () => {
    ...
    return (
        ...
        >
            ...
            <DialogContentText>
                Please enter your email address. If the email exists in our database, a reset link will be sent.
            </DialogContentText>
            <TextField
                fullWidth
                margin="normal"
